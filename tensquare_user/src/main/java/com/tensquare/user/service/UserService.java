...
public class UserService {
    ...
    public User findByMobile(String mobile, String password) {
        ...
        if (user != null && encoder.matches(password, user.getPassword())) {
            ...
            rsp.setSex(user.getSex());
            rsp.setBirthday(user.getBirthday());
            rsp.setAvatar(user.getAvatar());
            rsp.setEmail(user.getEmail());
            rsp.setRegdate(user.getRegdate());
            rsp.setLastdate(user.getLastdate());
            rsp.setOnline(user.getOnline());
            rsp.setInterest(user.getInterest());
            rsp.setPersonality(user.getPersonality());
            rsp.setFanscount(user.getFanscount());
            rsp.setFollowcount(user.getFollowcount());
            return rsp;
        } else {
            return null;
        }
